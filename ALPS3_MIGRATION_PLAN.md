...
| D10 | What to do with untracked local directories (`submission/`, `theory/`, `doc/`, `examples/SpM/`) | step 2 | Owner's call. Ignore or move them out of the tree. |
